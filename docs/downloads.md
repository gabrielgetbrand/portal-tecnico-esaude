...
* 📦 **Pacote IG FHIR + Perfis + Value Sets:** [BAIXAR EM BREVE]
    * *Contém a definição estrutural dos recursos e conjuntos de valores aceitos.*
* 🧪 **Coleções de Testes (Postman/Insomnia):** [BAIXAR EM BREVE]
    * *Scripts prontos para validar chamadas e fluxos de autenticação.*
* 📄 **Notas de Release e Compatibilidade:** [BAIXAR EM BREVE]
    * *Histórico de mudanças e requisitos mínimos do sistema.*

#### Artefatos Auxiliares:
* ⚙️ **Scripts de validação local e exemplos de pipelines:** [EM BREVE]
* 📊 **Dicionário de Mapeamento CDEM/RISAH (Excel):** [ADICIONAR LINK]
...
* 📄 [Portaria SMS nº 118/2026 (RISAH)](https://legislacao.prefeitura.sp.gov.br/leis/portaria-secretaria-municipal-da-saude-sms-118-de-24-de-fevereiro-de-2026/detalhe)
